 ...
 * @author PCxxCC1
 */
public class Ventana_Eliminar_Clientes extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Eliminar_Clientes
     */
    public Ventana_Eliminar_Clientes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(90, 100, 240, 35);

        jTextField1.setFont(new java.awt.Font("Arial", 2, 24)); // NOI18N
        getContentPane().add(jTextField1);
        jTextField1.setBounds(370, 100, 100, 35);
        ...
        Eliminar_Cliente_Eliminar.setBounds(330, 160, 170, 33);
        ...
        Eliminar_Cliente_Cancelar.setBounds(480, 10, 140, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Eliminar_Clientes.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-100, -70, 780, 430);
    ...
    private void Eliminar_Cliente_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Eliminar_Cliente_EliminarActionPerformed
        ...
        try {
            ...
            db.deleteRegistroClientes("clientes", jTextField1.getText());
            db.closeConnection();
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Eliminar_Clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Ventana_Eliminar_Clientes().setVisible(true);
            }
        });
    }
